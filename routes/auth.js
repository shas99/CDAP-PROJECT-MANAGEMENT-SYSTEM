...
const { register,viewfeedback,viewmarks, login,forgotpassword,resetpassword,groupregister,suggestsupervisor,group,GroupregisterConfirm} = require('../controllers/auth')
