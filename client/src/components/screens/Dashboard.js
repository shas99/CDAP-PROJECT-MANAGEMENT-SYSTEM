    ...
    <div class="flex ">
        <div x-data="{ open: true }" class="fixed top-0  z-50">
            ...
            <div  class="flex flex-col items-center w-48 h-screen overflow-hidden text-gray-300 bg-gray-800 rounded  " >
                ...
                <a class="flex items-center justify-center w-full h-16 mt-auto bg-gray-800 hover:bg-gray-700 " href="log.php">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 items-center  mt-10 px-7 rounded-2xl bg-gray-800 lg:bg-indigo-700 shadow-md pb-5">
                ...
                <div id="col" class='lg:w-[38vw] md:-translate-y-2'>
                    <h1 class="text-xl md:text-3xl mt-3 md:mt-10 ">Hey, <span class="font-semibold"> Chathushka Rodrigo</span></h1>
                    <h1 class="text-xs text-gray-400 mt-1"> Server Admin</h1>
                    <hr class="border-gray-300 mt-2 md:w-96 lg:hidden"/>
                </div>

                <div class="md:text-right mt-3">
                    <h1 class='text-sm text-g>ray-400'>chathushkarodrigo@gmail.com</h1>
                    <h1 class='text-3xl font-semibold text-gray-200'>IT20192600</h1>
