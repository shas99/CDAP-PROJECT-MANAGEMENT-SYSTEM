...
<div class="sidebar">
  ...
  <a href="#about">About</a> */}
        ...
        <div class="flex flex-col items-center w-48 h-screen overflow-hidden text-gray-400 bg-gray-900 ">
            ...
            <span class="ml-2 text-sm font-bold">Calibre</span>
                </a>
                <div class="flex flex-col items-center mt-3 border-t border-gray-700">
                    <a class="flex items-center justify-center w-13 h-12 mt-3 rounded hover:bg-gray-700 hover:text-gray-300" href="#">
