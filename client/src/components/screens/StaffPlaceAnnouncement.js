...
const Swal = require('sweetalert2')
  ...
  return (
    <div className='bg-gray-900 w-180 bg-grey-800  h-[60rem] ' >
        <br/><br/><br/> 
        <div class="flex flex-col items-center w-48 h-full-screen overflow-hidden text-gray-300 bg-gray-800 rounded mt-[-5rem]">
        <SideNavigationBar page="StaffPlaceAnnouncement"/>
        </div>
        <h1 className=' ml-[32rem] text-4xl text-gray-100 mt-[-725px]'>Post Annnouncement</h1>
 ...
 <br/>
  <div class="mb-6 w-56 ">
    ...
    <input type="text" required
     className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-l rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-500 dark:border-gray-200 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light left-50" onChange={(e) => setTitle(e.target.value)}
...
<textarea id="message" rows="4" required class="block p-2.5  text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..." onChange={(e) => setDescription(e.target.value)}
         style={{color:"white"}} value={description}></textarea>
