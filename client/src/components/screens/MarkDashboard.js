  ...
  return error ? (
    ...
    <>
      <div id='back' style={{ height: '50rem' }}>
        ...
        <h1 id='caption' style={{ marginTop: '-600px' }}>
        ...
        <div className='row1' style={{ marginLeft: '200px' }}>
          ...
          <div className='StaffRectangle-37'>
            ...
            <FontAwesomeIcon
              className='fonticonsize'
              icon={faFileCircleCheck}
            />
            {/* <i class="fa-solid fa-comment"></i> */}
            {/* <Link to="#" id="Regs"><button className="buttons" onClick="#">Add Marks</button></Link> */}
            <Link to='/addproposalpresentationmarks' id='Regs'>
              <button className='buttons'>Proposal presentation</button>
            </Link>
          </div>
          ...
          <div className='StaffRectangle-37'>
            ...
            {/* <i class="fa-solid fa-comment"></i> */}
            {/* <Link to="#" id="Regs"><button className="buttons" onClick="#">Add Marks</button></Link> */}
            <Link to='/addproposalreportmarks' id='Regs'>
              <button className='buttons'>Proposal report</button>
            </Link>
          </div>
          ...
          <div className='StaffRectangle-37'>
            ...
            {/* <i class="fa-solid fa-comment"></i> */}
            {/* <Link to="#" id="Regs"><button className="buttons" onClick="#">Add Marks</button></Link> */}
            <Link to='/enterstatusdocument1marks' id='Regs'>
              <button className='buttons'>Status document 1 </button>
            </Link>
          </div>
          ...
          <div className='StaffRectangle-37'>
            ...
            {/* <i class="fa-solid fa-comment"></i> */}
            {/* <Link to="#" id="Regs"><button className="buttons" onClick="#">Add Marks</button></Link> */}
            <Link to='/enterprogresspresentation1marks' id='Regs'>
              <button className='buttons'>Progress Presentation 1 </button>
            </Link>
          </div>
